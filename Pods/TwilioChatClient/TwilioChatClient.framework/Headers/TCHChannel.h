 ...
 */
- (void)chatClient:(TwilioChatClient *)client channel:(TCHChannel *)channel member:(TCHMember *)member user:(TCHUser *)user updated:(TCHUserUpdate)updated;
 ...
 */
- (void)chatClient:(TwilioChatClient *)client channel:(TCHChannel *)channel member:(TCHMember *)member userSubscribed:(TCHUser *)user;
 ...
 */
- (void)chatClient:(TwilioChatClient *)client channel:(TCHChannel *)channel member:(TCHMember *)member userUnsubscribed:(TCHUser *)user;
