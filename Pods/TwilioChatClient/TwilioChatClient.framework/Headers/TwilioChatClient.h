...
@property (nonatomic, strong, readonly) TCHUser *user;
...
/** Register APNS token for push notification updates.
 ...
 @param completion Completion block that will specify the result of the operation.
 */
- (void)registerWithNotificationToken:(NSData *)token
                           completion:(TCHCompletion)completion;
...
/** De-register from push notification updates.
 ...
 @param completion Completion block that will specify the result of the operation.
 */
- (void)deregisterWithNotificationToken:(NSData *)token
                             completion:(TCHCompletion)completion;
