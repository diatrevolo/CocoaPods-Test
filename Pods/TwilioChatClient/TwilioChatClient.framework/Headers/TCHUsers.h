 ...
 */
- (void)userDescriptorsForChannel:(TCHChannel *)channel
                       completion:(TCHUserDescriptorPaginatorCompletion)completion;
 ...
 */
- (void)userDescriptorWithIdentity:(NSString *)identity
                        completion:(TCHUserDescriptorCompletion)completion;
 ...
 */
- (void)subscribedUserWithIdentity:(NSString *)identity
                        completion:(TCHUserCompletion)completion;

/** Obtain a reference to all currently subscribed users in the system.
 
 @return An array of subscribed TCHUser objects.
 */
- (NSArray<TCHUser *> *)subscribedUsers;
